...
| 2026-08-03 | ros2-diffdrive: replaced local \_ensure_reactor() with shared henosync_sdk.rosbridge.ensure_reactor() — fixes crash when both ros2-diffdrive and turtlebot3 loaded simultaneously; added advertise() on cmd_vel_topic; added callFromThread for publish in handle_custom_command and get_safe_state; negated angular to match ROS angular.z convention                                                                                                                                                                        |
...
| 2026-08-05 | Refactored turtlebot3, ue-sim, ros2-diffdrive to subclass ROS2Plugin; plugins now only implement create_state/setup_node/build_telemetry/callbacks/command handlers; all connection boilerplate removed                                                                                                                                                                                                                                                                                                                       |

| 2026-08-05 | Updated plugins/templates/device-template/plugin.py — replaces old NodePlugin boilerplate with ROS2Plugin (Option A, active) and MAVLinkPlugin (Option B, commented out) starters; includes GPS/VICON branching, position health checks, no-fix warnings, and cmd_vel publisher pattern |
